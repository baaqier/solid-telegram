...
var sections = [{
  ...
  questions: [
    { question: ' How friendly was our sales manager?', rating: 0 },
    { question: ' How knowledgable was our sales manager?', rating: 0 },
    { question: ' How responsive was our sales manager?', rating: 0 },
    { question: ' Overall explanation of the apartment.', rating: 0 },
...
function enableQuestionOnScroll() {
  ...
  $('.feedback-section').first().css('padding-top:6px', feedbackFormHeight/2);
